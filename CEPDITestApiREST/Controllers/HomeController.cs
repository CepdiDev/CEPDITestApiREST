...
namespace CEPDITestApiREST.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public ActionResult TimbrarDocumento(string Usuario, string Password, string Layout)
        {
            ...
            var client = new RestClient("https://localhost:44373/api/Timbrado/TimbrarComprobanteKAVAK");
            client.Timeout = -1;
        ...
        public ActionResult ObtenerPDF(string UUID, string Usuario, string Password)
        {
            ...
            var client = new RestClient("https://localhost:44373/api/Timbrado/ObtenerPDFComprobanteKAVAK");
            client.Timeout = -1;
            var request = new RestRequest(Method.POST);
            request.AddHeader("Content-Type", "application/json");
            request.AddParameter("application/json", body, ParameterType.RequestBody);
